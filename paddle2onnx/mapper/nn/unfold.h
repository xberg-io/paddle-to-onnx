...
public:
  ...
  void Opset11();
  std::string
  _get_im2col_indices_along_dim(std::string intput_d, int64_t kernel_size_d,
                                int64_t dialation_d, int64_t padding_start_d,
                                int64_t padding_end_d, int64_t stride_d);
