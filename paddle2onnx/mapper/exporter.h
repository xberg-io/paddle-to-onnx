...
public:
  ...
  std::string Run(const PaddlePirParser &pir_parser, int opset_version,
...
private:
  ...
  void ExportWhile(const PaddlePirParser &pir_parser, OnnxHelper *temp_helper,
                   pir::Operation *op);
  ...
  int32_t GetMinOpsetVersion(const PaddlePirParser &pir_parser,
                             const pir::Block *block, bool if_in_sublock);
  ...
  ExportConditionalBlock(const PaddleParser &parser, OnnxHelper *temp_helper,
  ...
  void ExportOp(const PaddleParser &parser, OnnxHelper *helper,
                ...
                bool verbose);
  void ExportOp(const PaddlePirParser &pir_parser, OnnxHelper *helper,
                int32_t opset_version, pir::Operation *op, int64_t op_id,
