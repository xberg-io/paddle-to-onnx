...
REGISTER_PIR_MAPPER(asin, ActivationMapper)
REGISTER_MAPPER(atan, ActivationMapper)
REGISTER_PIR_MAPPER(atan, ActivationMapper)
...
REGISTER_PIR_MAPPER(elu, EluMapper)
REGISTER_MAPPER(erf, ActivationMapper)
REGISTER_PIR_MAPPER(erf, ActivationMapper)
...
REGISTER_PIR_MAPPER(selu, SeluMapper)
...
REGISTER_PIR_MAPPER(softplus, ActivationMapper)
REGISTER_MAPPER(softshrink, SoftShrinkMapper)
REGISTER_PIR_MAPPER(softshrink, SoftShrinkMapper)
REGISTER_MAPPER(softsign, ActivationMapper)
REGISTER_PIR_MAPPER(softsign, ActivationMapper)
...
void ActivationMapper::Opset7() {
  ...
  Assert(op_mapper_.end() != iter, "Cannot find " +
...
void Log1PMapper::Opset7() {
  auto x_info = GetInput("X");
  auto out_info = GetOutput("Out");
  auto one = helper_->Constant({}, GetOnnxDtype(x_info[0].dtype),
