...
REGISTER_PIR_MAPPER(bitwise_and, BitWiseMapper)
REGISTER_PIR_MAPPER(bitwise_not, BitWiseMapper)
REGISTER_PIR_MAPPER(bitwise_or, BitWiseMapper)
REGISTER_PIR_MAPPER(bitwise_xor, BitWiseMapper)
