...
class Net(paddle.nn.Layer):
    ...
    def forward(self, inputs, inputs_):
        ...
        forward
        """
        return paddle.logical_or(inputs, inputs_)


def test_logical_or_7():
    """
    api: paddle.logical_or
    op version: 7
    """
    op = Net()
    op.eval()
    # net, name, ver_list, delta=1e-6, rtol=1e-5
    obj = APIOnnx(op, "logical_or", [7])
    obj.set_input_data(
        "input_data",
