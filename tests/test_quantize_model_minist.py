...
class TestPostTrainingHistForMnistONNXFormatFullQuant(TestPostTrainingQuantization):
...
class TestPostTrainingAvgForMnistONNXFormatFullQuant(TestPostTrainingQuantization):
