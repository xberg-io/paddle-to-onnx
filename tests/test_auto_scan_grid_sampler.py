...
class TestGroupNormConvert(OPConvertAutoScanTest):
    ...
    def sample_convert_config(self, draw):
        input_shape = draw(st.lists(st.integers(min_value=4, max_value=10), min_size=4, max_size=4))

        grid_shape = draw(st.lists(st.integers(min_value=4, max_value=10), min_size=4, max_size=4))
